...
const ManageEmployees = () => {
  ...
  const handleEditSubmit = async (event) => {
    ...
    const payload = {
      ...
      officeLocation:
        typeof editFormData.officeLocation === "string"
          ? editFormData.officeLocation.trim()
          : "",
      role: requestedRole,
    };
    ...
    <DashboardLayout activeMenu="Employees">
                                ...
                                {allowManagement && (
                                  <>
                                    <button
                                      ...
                                      className="rounded-full border border-slate-200 bg-white p-2 text-slate-600 transition hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700 dark:border-slate-700 dark:bg-slate-900/70 dark:text-slate-200 dark:hover:border-indigo-400 dark:hover:bg-indigo-500/15 dark:hover:text-indigo-100"
                                    >
      ...
      {showEditModal && editUser && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 px-4 py-6">
          <div className="w-full max-w-5xl rounded-2xl bg-white p-6 shadow-2xl dark:border dark:border-slate-800 dark:bg-slate-900 dark:shadow-slate-950/70">
            <div className="flex flex-col gap-1 sm:flex-row sm:items-start sm:justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  Update the employee&apos;s details and save your changes.
                </p>
              </div>
              <button
                type="button"
                ...
                className="mt-3 inline-flex h-9 items-center justify-center rounded-full border border-slate-200 px-3 text-sm font-semibold text-slate-600 transition hover:bg-slate-100 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800 sm:mt-0"
              >
                Close
              </button>
            </div>
            ...
            <form className="mt-5 space-y-4" onSubmit={handleEditSubmit}>
              <div className="grid gap-4 md:grid-cols-2">
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="editName" className="text-sm font-medium text-slate-700 dark:text-slate-200">
                    Full Name
                  </label>
                  <input
                    id="editName"
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="editEmail" className="text-sm font-medium text-slate-700 dark:text-slate-200">
                    Email Address
                  </label>
                  <input
                    id="editEmail"
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="editPassword" className="text-sm font-medium text-slate-700 dark:text-slate-200">
                    Password
                  </label>
                  <input
                    id="editPassword"
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="editConfirmPassword" className="text-sm font-medium text-slate-700 dark:text-slate-200">
                    Confirm Password
                  </label>
                  <input
                ...
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center justify-between gap-3">
                    <label htmlFor="editEmployeeRole" className="text-sm font-medium text-slate-700 dark:text-slate-200">
                      Employee Role
                    </label>
                    <button
                      type="button"
                  ...
                  <div className="relative" ref={editEmployeeRoleDropdownRef}>
                    <button
                      id="editEmployeeRole"
                      type="button"
                      className="flex h-11 w-full items-center justify-between rounded-lg border border-slate-200 bg-white px-3.5 text-left text-sm text-slate-800 shadow-inner transition focus:border-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-100 disabled:cursor-not-allowed disabled:opacity-70 dark:border-slate-700 dark:bg-slate-950/70 dark:text-slate-100 dark:focus:border-indigo-400 dark:focus:ring-indigo-500/30"
                    ...
                    >
                      <span
                        className={
                          editFormData.employeeRole ? "" : "text-slate-400 dark:text-slate-500"
                        }
                      >
                        {isRoleLoading
                          ? "Loading roles..."
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="editGender" className="text-sm font-medium text-slate-700 dark:text-slate-200">
                    Gender
                  </label>
                  <select
                    id="editGender"
                ...
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center justify-between gap-3">
                    <label htmlFor="editOfficeLocation" className="text-sm font-medium text-slate-700 dark:text-slate-200">
                      Office Location
                    </label>
                    <button
                      type="button"
                  ...
                  <div className="relative" ref={editOfficeLocationDropdownRef}>
                    ...
                    >
                      <span
                        className={
                          editFormData.officeLocation ? "" : "text-slate-400 dark:text-slate-500"
                        }
                      >
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="editRole" className="text-sm font-medium text-slate-700 dark:text-slate-200">
                    Access Level
                  </label>
                  <select
                    id="editRole"
              ...
              <div className="flex justify-end gap-3">
                <button
                  ...
                  className="inline-flex h-10 items-center justify-center rounded-full border border-slate-200 px-4 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="inline-flex h-10 items-center justify-center rounded-full bg-indigo-600 px-5 text-sm font-semibold text-white shadow-[0_10px_22px_rgba(79,70,229,0.35)] transition hover:bg-indigo-500 disabled:cursor-not-allowed disabled:opacity-70"
                >
                  {isUpdatingUser ? (
                    <>
